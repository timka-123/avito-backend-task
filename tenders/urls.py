...
urlpatterns = [
    ...
    path("/<str:tender_id>/status", TenderStatusView.as_view()),
    path("/<str:tender_id>/edit", EditTenderView.as_view()),
    path("/<str:tender_id>/rollback/<int:version>", RollbackTender.as_view())
]
